...
def get_data_availability(sh_name, file_name, path='./data/rst_files_repo/'):
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='M:O, P:R, S:U, W:Y, Z:AB',
                         skiprows=range(3), nrows=1)
    df = pd.DataFrame(data)
    df = df.round().astype(int)
    availtsl = df.values.flatten().tolist()

    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='M, P, S, W, Z', skiprows=range(4),nrows=1)
    df=pd.DataFrame(data)
    df=df.round().astype(int)
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='A:H', skiprows=range(2),nrows=69)
    df=pd.DataFrame(data)
    ...
    del df
    return (availtsl, availts, mtustatus, udate, tslistok4, tslistok5, tslistok6, tslistpok4, tslistpok5, tslistpok6,
            tslistnok4, tslistnok5, tslistnok6, mtustatus)
...
# ******** Train Availability.html data from Excel file
# def get_data_avail(sh_name, file_name, path='./data/rst_files_repo/'):
#     data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='M:O, P:R, S:U, W:Y, Z:AB', skiprows=range(3),nrows=1)
    # df=pd.DataFrame(data)
    # df=df.round().astype(int)
    # availtsl = df.values.flatten().tolist()
    #
    ...
    # data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='A:B', skiprows=range(2),nrows=69)
    # df=pd.DataFrame(data)
    #
    # df4=df.loc[df[1] == 'OK']
    # df4=df4[df[0].str.contains(r'TS4(?!$)')]
    # tslistok4 = df4[0].values.flatten().tolist()
    # if len(tslistok4)==0:
    #     tslistok4=["None"]
    #
    # df5 = df.loc[df[1] == 'OK']
    ...
    # del df
    # return (availtsl, availts, mtustatus, tslistok4, tslistok5, tslistok6, tslistpok4, tslistpok5, tslistpok6,
    #         tslistnok4, tslistnok5, tslistnok6, udate)





# ******** Configuration Line 4.html data from Excel file
...
def get_data_configl4(sh_name, file_name, path='./data/rst_files_repo/'):
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='A,B,E', skiprows=range(2),nrows=24)
    df=pd.DataFrame(data)
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='G,I,K,M,O,Q,S,U,W,Y,AA', skiprows=range(2), nrows=24)
    df = pd.DataFrame(data)
    swl4= df.values.tolist()

    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='H,J,L,N,P,R,T,V,X,Z,AB', skiprows=range(2), nrows=24)
    df = pd.DataFrame(data)
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, usecols='G,I,K,M,O,Q,S,U,W,Y,AA', skiprows=range(25), nrows=1)
    df = pd.DataFrame(data)
    df = df.round(1)
...
def get_data_configl5(sh_name, file_name, path='./data/rst_files_repo/'):
    ...
    # Checking Mileage sorting
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='A,B,E', skiprows=range(2),nrows=19)
    df=pd.DataFrame(data)
    df[1]=df[1].round().astype(int)
    df=df.sort_values([1], ascending=True)
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='G,I,K,M,O,Q,S,U,W,Y,AA', skiprows=range(2), nrows=19)
    df = pd.DataFrame(data)
    df = df.apply(lambda x: x.astype(str).str.upper())
    swl5= df.values.tolist()

    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='H,J,L,N,P,R,T,V,X,Z,AB', skiprows=range(2), nrows=19)
    df = pd.DataFrame(data)
    df=df.replace("BASELINE", "badge badge-success")
    df = df.replace("RESTRICTED", "badge badge-warning")
    df = df.replace("NOT OK", "badge badge-danger")
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, usecols='G,I,K,M,O,Q,S,U,W,Y,AA', skiprows=range(20), nrows=1)
    df = pd.DataFrame(data)
    df = df.round(1)
...
def get_data_configl6(sh_name, file_name, path='./data/rst_files_repo/'):
    ...
    # data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='B:B', skiprows=range(2),nrows=26)
    # df=pd.DataFrame(data)
    # df=df.round().astype(int)
    # tml6=df.values.tolist()
    # print(tml6)


    # Checking Mileage sorting
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='A,B,E', skiprows=range(2),nrows=26)
    df=pd.DataFrame(data)
    df[1]=df[1].round().astype(int)
    df=df.sort_values([1], ascending=True)
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='G,I,K,M,O,Q,S,U,W,Y,AA', skiprows=range(2), nrows=26)
    df = pd.DataFrame(data)
    df = df.apply(lambda x: x.astype(str).str.upper())
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='H,J,L,N,P,R,T,V,X,Z,AB', skiprows=range(2), nrows=26)
    df = pd.DataFrame(data)
    df=df.replace("BASELINE", "badge badge-success")
    df = df.replace("RESTRICTED", "badge badge-warning")
    df = df.replace("NOT OK", "badge badge-danger")
    ...
    data = pd.read_excel(path + file_name, sheet_name=sh_name, usecols='G,I,K,M,O,Q,S,U,W,Y,AA', skiprows=range(27), nrows=1)
    df = pd.DataFrame(data)
    df = df.round(1)
...
def get_data_tir(sh_name, file_name, path='./data/rst_files_repo/'):
    ...
    df = df.sort_values(by='RI Date', ascending=False)

    df['RI Date'] = pd.to_datetime(df['RI Date']).dt.strftime('%d-%b-%Y')
    # df['Target Date'] = pd.to_datetime(df['Target Date']).dt.strftime('%d-%b-%Y')
    df = df.fillna('')

    df['Closing Date'] = pd.to_datetime(df['Closing Date']).dt.strftime('%d-%b-%Y')
    # df['Target Date'] = pd.to_datetime(df['Target Date']).dt.strftime('%d-%b-%Y')
    df = df.fillna('')
    ...
    #
    start_word1 = next(iter(df[df['V'] == 'TIR Status'].index), 'no match')
    ...
    #
    #
    start_word2 = next(iter(df[df['V'] == 'Closure Status'].index), 'no match')
    ...
    start_word3 = next(iter(df[df['V'] == 'PIC'].index), 'no match')
    ...
    start_word4 = next(iter(df[df['V'] == 'Origin Status'].index), 'no match')
    ...
    return (tirlist, lbltir, valtir, lblorigin, valorigin, lblpic, valpic, lblclosure, valclosure, udate)
...
def get_data_pmtest(sh_name, file_name, path='./data/rst_files_repo/'):
    ...
    return (pmlist, pm2week, pmmonth, pm2month, pmquart, udate)
...
def get_data_reliability(sh_name, file_name, path='./data/rst_files_repo/'):
    ...
    # ****** IOS History *******
    data = pd.read_excel(path + file_name, sheet_name=sh_name, header=None, usecols='L:P', skiprows=range(3))
    df = pd.DataFrame(data)
    df = df.set_axis(['month', 'corrected', 'ongoing', 'ui', 'detected'], axis=1, inplace=False)
    df = df.dropna()
    his_mon = df["month"].tolist()
    his_co = df["corrected"].tolist()
    his_on = df["ongoing"].tolist()
    his_ui = df["ui"].tolist()
    his_det = df["detected"].tolist()
    # print(his_mon)
    # print(his_co)

    # ****** IOS Details *******
    data = pd.read_excel(path + file_name, sheet_name=sh_name, usecols='D:I', skiprows=range(16))
    df = pd.DataFrame(data)
    ...
    return (lbl_all, total_ios, unique_ios, impact_ios,tracker_co,tracker_og,tracker_ui,tracker_del, tracker_sum,
            his_mon, his_co, his_on, his_ui, his_det,ioslist, lenlist, udate)
